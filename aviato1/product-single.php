<?php
$id=$_GET['id'];
$con=mysqli_connect("localhost","root","","addweb");
$query1=mysqli_query($con,"Select * from ecom where id=$id") or die("Error in Query");
...
<head>
  ...
  <!-- Favicon -->
  <link rel="shortcut icon" type="image/x-iidcon" href="images/favicon.png" />
		...
		<div class="container">
			...
			<div id="navbar" class="navbar-collapse collapse text-center">
				<ul class="nav navbar-nav">
                    ...
                    'images/shop/single-products/product-6.jpg'
					<!-- Blog -->
					<li class="dropdown dropdown-slide">
						<a href="#!" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="350"
						...
						<div class='carousel-outer'>
							...
							<div class='carousel-inner '>
								<div class='item active'>
									<img src='<?php echo $image ?>' alt='' data-zoom-image="images/shop/single-products/product-1.jpg" />
								</div>
								<div class='item'>
									<img src='<?php echo $image ?>' alt='' data-zoom-image="images/shop/single-products/product-2.jpg" />
								</div>
								
								<div class='item'>
									<img src='<?php echo $image ?>' alt='' data-zoom-image="images/shop/single-products/product-3.jpg" />
								</div>
								<div class='item'>
									<img src='<?php echo $image ?>' alt='' data-zoom-image="images/shop/single-products/product-4.jpg" />
								</div>
								<div class='item'>
									<img src='<?php echo $image ?>' alt='' data-zoom-image="images/shop/single-products/product-5.jpg" />
								</div>
								<div class='item'>
									<img src='<?php echo $image ?>' alt='' data-zoom-image="images/shop/single-products/product-6.jpg" />
								</div>
