...
$query1=mysqli_query($con,"Select * from ecom") or die("Error in Query");
			...
			<div class="col-md-4">
				<div class="product-item">
					<div class="product-thumb">
						...
						<img class="img-responsive" src=<?php echo $image ?> alt="product-img" />
					...
					<div class="product-content">
						<h4><a href="product-single.php?id=<?php echo $id ?>"><?php echo $name ?></a></h4>
