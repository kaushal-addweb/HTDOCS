                    ...
                    <div class="col-lg-4 mx-auto">
                        <div class="auth-form-light text-left p-5">
                            ...
                            <form class="pt-3" method="post">
                                ...
                                <div class="mt-3">
                                <input type="submit" class="btn btn-block btn-gradient-primary btn-lg font-weight-medium auth-form-btn" value="Login" name="Login"></input>
                                </div>
...
if (isset($_POST['Login'])) {
    ...
    $sql = "Select * from login where username='$semail' and password='$spass'";
